...
namespace Test02 {
    internal class Program {
        ...
        private static void Exercise03(int[] numbers) {
            foreach (var i in numbers.Order()) {
                Console.Write(i + " ");
            }
        }
        ...
        private static void Exercise04(int[] numbers) {
            foreach (var i in numbers.Where(n => n >= 10 && 50 >= n )) {
                Console.Write(i + " ");
            }
        ...
        private static void Exercise08(List<string> cities) {
            foreach (var i in cities) {
                Console.WriteLine(i + " : " + i.Length + "文字");
            }
        }
        ...
        private static void Exercise09(List<string> cities) {
            var AcsCntMoji = cities.OrderBy(s => s.Length);
            foreach (var i in AcsCntMoji) {
                Console.WriteLine(i + " : " + i.Length + "文字");
            }
        }
        ...
        private static void Exercise10(List<string> cities) {
            var rokuMoji = cities.Where(s => s.Length == 6);
            foreach (var i in rokuMoji) {
                Console.WriteLine(i);
            }
        }
    }

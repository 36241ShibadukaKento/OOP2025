...
//MetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnitMetricUnit
namespace SamoleUnitConverter
{
    class MetricUnit :DistanceUnit
    {
        private static List<MetricUnit> units = new List<MetricUnit> {
            ...
            new MetricUnit{Name = "km",Coefficient =1 * 100 * 1000,},
        };
